...
const Services = () => {
    ...
    const { docData, isLoading, refetch } = useDocData();
    console.log(docData);
    ...
    return (
        <div className="bg-gradient-to-t from-cyan-200 pb-14">
            ...
            <div className="grid grid-cols-4 justify-items-center gap-5 px-16">
                {
                    docData.slice(0, 8).map((data, idx) => <div key={idx} className="card bg-base-100 shadow-xl">
                        <figure className="bg-cyan-100">   <img
